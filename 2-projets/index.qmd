...
**Étape 2 — Tableaux `gt`.** À la fin de chaque pipeline `gt`, ajoutez le bloc suivant (utilisable tel quel sur les 3 tableaux du livre — `01-anatomie.qmd` + `02-origines.qmd`) :
...
**Combo avec Bonus 3** : swappez le `_brand.yml` — les lignes 1 des tableaux et les barres du graphique espèces suivent automatiquement la nouvelle couleur `primary`. La charte pilote le PDF *et* tous les outputs R depuis un seul fichier.
