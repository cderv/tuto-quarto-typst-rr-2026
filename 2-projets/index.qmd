...
Si vous bloquez sur la syntaxe, voici un patron complet à adapter (état final après 2a **et** 2b — pour 2a seul, omettez le bloc `appendices:`) :
...
book:
  ...
  chapters:
    ...
    - 02-origines.qmd
    - conclusion.qmd
  appendices:           # ← ajouté à l'étape 2b
    - annexe-donnees.qmd
