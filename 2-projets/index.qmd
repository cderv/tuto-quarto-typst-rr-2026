...
📄 La **charte Star Wars** reste votre référence visuelle (même `charte-starwars.pdf` qu'au Bloc 1, fourni dans le starter) — vous ne la retranscrivez pas ici, vous appliquez le `_brand.yml` que vous avez déjà (ou le fallback) à un projet livre.
:::
