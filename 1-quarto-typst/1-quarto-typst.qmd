...
::: notes
Annoncer clairement la durée (~10 min) et l'heure de reprise (cf. chronogramme de pilotage : reprise à 11h00). Inviter à se dégourdir les jambes. Rappeler que le Bloc 2 repart de leur `_brand.yml` du Bloc 1 (ou du `_brand-starter.yml` de secours pour les arrivants / ceux qui n'ont pas fini) — l'arc `.qmd → livre` continue, on ne repart pas de zéro.
:::