...
4.  Créez un `_brand.yml` avec 2 couleurs et une police Google sur le corps
5.  Ajoutez la police locale Star Jedi (TTF dans `_fonts/`) sur les titres de section via `source: file`
6.  Activez `keep-typ: true` et explorez le fichier `.typ` généré
:::
...
3.  Créez un `_brand.yml` avec vos couleurs et une police Google sur le corps (`base:`)
4.  Ajoutez la police locale Star Jedi (`_fonts/Starjedi.ttf`, `source: file`) sur les titres (`headings:`)
5.  Activez `keep-typ: true` et ouvrez le fichier `.typ` généré
:::
