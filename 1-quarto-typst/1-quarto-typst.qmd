...
[Typst](https://typst.app/) — un système de composition pour produire des PDFs. Dans la chaîne Quarto, il joue le même rôle que LaTeX.

::: incremental
- **Un autre moteur pour produire des PDFs** — il prend la place de LaTeX entre votre `.qmd` et votre `.pdf`
- **Embarqué dans Quarto** depuis la version 1.5 — rien à installer en plus
- **Pas besoin de l'apprendre pour démarrer** — Quarto traduit votre Markdown en Typst à votre place
:::

::: notes
**Option A à choisir avec l'option B (slide suivante) — supprimer celle qui ne convient pas.**

Trois messages : (1) Typst occupe la même place que LaTeX dans le pipeline, (2) c'est déjà là dans Quarto, (3) la syntaxe Typst n'est pas un prérequis. Le `keep-typ: true` 2 slides plus loin permettra à celles et ceux qui veulent de regarder sous le capot.
:::

## C'est quoi Typst ? *(option B — visuel)*

[Typst](https://typst.app/) joue le même rôle que LaTeX : produire un PDF. Avec Quarto, vous restez côté Markdown — la traduction vers Typst se fait toute seule.
