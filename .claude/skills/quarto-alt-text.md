...
description: >
  ...
  Use when adding fig-alt attributes to figures in .qmd files.
metadata:
  author: Posit
  version: "1.0"
  source: https://github.com/posit-dev/skills/tree/main/quarto/quarto-alt-text
license: MIT
---
...
**fig-cap:** "Normalization doesn't make data more normal."
