...
- Helpers R pour propager la charte aux sorties graphiques : [paquet `brand.yml`](https://posit-dev.github.io/brand-yml/pkg/r/) — `theme_brand_ggplot2()`, `theme_brand_gt()`, `theme_brand_flextable()`, `theme_brand_plotly()`, `theme_brand_thematic()`
...
## Template partials (fragments de gabarit) — guide
