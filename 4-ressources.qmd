...
- `quarto use brand user/repo` — partager une brand depuis GitHub

Dans les blocs raw Typst, les variables brand sont accessibles via `brand-color.primary`, `brand-color.secondary`, `brand-logo-images`.
...
- Accédez aux variables brand : `brand-color.primary`, `brand-logo-images`
...
**Attention** : Quarto décale les titres d'un niveau. Le `# h1` du `.qmd` devient `heading(level: 2)` dans Typst.
