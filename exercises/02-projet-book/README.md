...
Sur le site : [Bloc 2 — Projets & book](https://cderv.github.io/cderv-tuto-quarto-typst-rr-2026/2-projets/) — étapes, indices doc, modèle `_quarto.yml`, bonus B3/B4 pour aller plus loin, bloc « Si vous bloquez », correction.
